package com.example.ah.sensorsaccess.SensorActivities;
...
import com.example.ah.sensorsaccess.R;
...
public class SensLinearAccelerometerActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_linearaccelerometer);
        ...
        graphY.getViewport().setMaxX(SystemClock.currentThreadTimeMillis());
        graphY.addSeries(seriesY);

        graphZ = (GraphView)findViewById(R.id.graphZ);
        graphZ.getViewport().setXAxisBoundsManual(true);
        graphZ.getViewport().setMaxX(SystemClock.currentThreadTimeMillis());
